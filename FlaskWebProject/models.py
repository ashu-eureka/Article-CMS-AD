...
BLOB_URL = "https://{}.blob.core.windows.net/".format(app.config['BLOB_ACCOUNT'])
#blob_service = BlockBlobService(account_name=app.config['BLOB_ACCOUNT'], account_key=app.config['BLOB_STORAGE_KEY'])
blob_service = BlobServiceClient(account_url=BLOB_URL, credential=app.config['BLOB_STORAGE_KEY'])
